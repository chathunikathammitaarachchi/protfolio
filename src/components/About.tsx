          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              <div className="p-6 bg-slate-800/40 rounded-3xl border border-slate-700/50 text-center shadow-lg backdrop-blur-sm group hover:bg-slate-800/60 transition-colors">
                <h5 className="font-bold text-4xl bg-linear-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform">6+</h5>
                <p className="text-slate-400 text-sm font-semibold">Projects Completed</p>
              </div>
              <div className="p-6 bg-slate-800/40 rounded-3xl border border-slate-700/50 text-center shadow-lg backdrop-blur-sm group hover:bg-slate-800/60 transition-colors">
                <h5 className="font-bold text-4xl bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2 group-hover:scale-110 transition-transform">3+</h5>
